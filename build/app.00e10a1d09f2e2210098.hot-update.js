...
var messagePage = (function (_super) {
    ...
    messagePage.prototype.createMessage = function (newMessage) {
        var _this = this;
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("http://185.209.31.106:55558/message/create", { TopicId: this.props.match.params.id, title: newMessage, Html: "<h1></h1>" }, { headers: { Authorization: "Bearer " + this._authService.getAuthToken() } })
            .then(function (result) { return _this.getMessage(); });
    };
...
//# sourceMappingURL=app.00e10a1d09f2e2210098.hot-update.js.map