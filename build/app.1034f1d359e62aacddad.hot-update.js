...
/*!**********************************************************!*\
  !*** ./src/app/components/pages/message/MessagePage.tsx ***!
  \**********************************************************/
/*! exports provided: MessageArea, MessagePage, default */
...
/* harmony import */ var _MessagePage_css__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./MessagePage.css */ "./src/app/components/pages/message/MessagePage.css");
/* harmony import */ var _MessagePage_css__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_MessagePage_css__WEBPACK_IMPORTED_MODULE_10__);
...
var MessageArea = function (_a) {
    var createNewMessage = _a.createNewMessage;
    var _b = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(''), newMessage = _b[0], setNewMessage = _b[1];
    return (react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", { className: "messageArea" },
        react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(grommet__WEBPACK_IMPORTED_MODULE_1__["TextArea"], { placeholder: "\u041D\u043E\u0432\u043E\u0435 \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435", value: newMessage, onChange: function (event) { return setNewMessage(event.target.value); } }),
        react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(grommet__WEBPACK_IMPORTED_MODULE_1__["Button"], { type: "submit", label: "\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C", onClick: function () { createNewMessage(newMessage); setNewMessage(''); } })));
};
var messagePage = (function (_super) {
    ...
    messagePage.prototype.createMessage = function (newMessage) {
        var _this = this;
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("http://185.209.31.106:55558/message/create", { TopicId: this.props.match.params.id, Title: newMessage, Html: "<h1>" + newMessage + "</h1>" }, { headers: { Authorization: "Bearer " + this._authService.getAuthToken() } })
            .then(function (result) { return _this.getMessage(); });
    };
    messagePage.prototype.subcribe = function () {
        var _this = this;
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("http://185.209.31.106:55558/topic/" + this.props.match.params.id + "/subscribe", { headers: { Authorization: "Bearer " + this._authService.getAuthToken() } })
            .then(function (result) { _this.getMessage(); console.log("Pfkdnk"); });
    };
    messagePage.prototype.unsubcribe = function () {
        var _this = this;
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete("http://185.209.31.106:55558/topic/" + this.props.match.params.id + "/unsubscribe", { headers: { Authorization: "Bearer " + this._authService.getAuthToken() } })
            .then(function (result) { return _this.getMessage(); });
    };
                ...
                react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(grommet__WEBPACK_IMPORTED_MODULE_1__["Box"], { margin: "xlarge", pad: "medium", alignSelf: 'center', alignContent: "center", align: "center" },
                    react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(grommet__WEBPACK_IMPORTED_MODULE_1__["Card"], { elevation: "large", width: "large" },
                        react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(grommet__WEBPACK_IMPORTED_MODULE_1__["CardBody"], { height: "small" },
                            ...
                            react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(grommet__WEBPACK_IMPORTED_MODULE_1__["Button"], { label: "\u041F\u043E\u0434\u043F\u0438\u0441\u0430\u0442\u044C\u0441\u044F", onClick: function () { return _this.subcribe(); } }),
                            react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(grommet__WEBPACK_IMPORTED_MODULE_1__["Button"], { label: "\u041E\u0442\u043F\u0438\u0441\u0430\u0442\u044C\u0441\u044F", onClick: function () { return _this.unsubcribe(); } }),
                        ...
                        react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(grommet__WEBPACK_IMPORTED_MODULE_1__["CardFooter"], null,
                            react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(MessageArea, { createNewMessage: function (newMessage) { return _this.createMessage(newMessage); } })))))));
    };
    return messagePage;
...
//# sourceMappingURL=app.1034f1d359e62aacddad.hot-update.js.map