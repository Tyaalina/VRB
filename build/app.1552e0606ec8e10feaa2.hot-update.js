...
var AccountServerInteractionService = (function (_super) {
    ...
    function AccountServerInteractionService() {
        ...
        _this.getTopic = function (payload) {
            return _this.get("/topics", { headers: { 'Authorization': 'Bearer ' + _this._authService.getAuthToken() } });
        };
        return _this;
    }
...
//# sourceMappingURL=app.1552e0606ec8e10feaa2.hot-update.js.map