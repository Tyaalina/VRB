...
var MessagePage = (function (_super) {
    ...
    MessagePage.prototype.getMessage = function () {
        var _this = this;
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('http://185.209.31.106:55558/topic/', { headers: { Authorization: "Bearer " + this._authService.getAuthToken() } })
            .then(function (result) { return _this.props.dispatch(_this.actions.setMessage(result.data.topics)); });
    };
...
//# sourceMappingURL=app.2fc970c1e933e1d9bd54.hot-update.js.map