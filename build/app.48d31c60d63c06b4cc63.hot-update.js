...
var Topic = (function (_super) {
    ...
    Topic.prototype.deleteTopic = function (topicId) {
        var _this = this;
        axios__WEBPACK_IMPORTED_MODULE_8___default.a.delete("http://185.209.31.106:55558/topic/" + topicId + "/delete", { headers: { Authorization: "Bearer " + this._authService.getAuthToken() } })
            .then(function (result) { return _this.getTopics(); });
    };
    Topic.prototype.editComponent = function (topicId, title) {
        var _this = this;
        axios__WEBPACK_IMPORTED_MODULE_8___default.a.put("http://185.209.31.106:55558/topic/" + topicId + "/edit", { headers: { Authorization: "Bearer " + this._authService.getAuthToken() } })
            .then(function (result) { _this.getTopics(); console.log("Отредачили"); });
    };
...
//# sourceMappingURL=app.48d31c60d63c06b4cc63.hot-update.js.map