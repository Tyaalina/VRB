...
var RegistrationSaga = (function (_super) {
    ...
    function RegistrationSaga() {
        ...
        _this._authService = _inversify_inversifyContainer__WEBPACK_IMPORTED_MODULE_1__["default"].get(_inversify_inversifyTypes__WEBPACK_IMPORTED_MODULE_2__["SERVICE_IDENTIFIER"].AuthService);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, this.doSubmitApiRequest(action, this.serverInteractionService.register(action.payload.dto), function (response) {
                        ...
                        _utils_helpers_HistoryHelper__WEBPACK_IMPORTED_MODULE_5__["default"].push(_shared_constants_routes__WEBPACK_IMPORTED_MODULE_6__["ROOT_ROUTE"]);
                    })];
                case 1:
                    _a.sent();
                    return [2];
...
//# sourceMappingURL=app.5cd152436d5f222796fb.hot-update.js.map