...
/* harmony import */ var _shared_input_inputComponent__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../shared/input/inputComponent */ "./src/app/components/shared/input/inputComponent.tsx");
/* harmony import */ var _shared_wrappers_FormMessageWrapper__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../shared/wrappers/FormMessageWrapper */ "./src/app/components/shared/wrappers/FormMessageWrapper.tsx");
/* harmony import */ var _shared_wrappers_FormPlaceholder__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../shared/wrappers/FormPlaceholder */ "./src/app/components/shared/wrappers/FormPlaceholder.tsx");
...
var RegistrationFormComponent = (function (_super) {
    ...
    function RegistrationFormComponent(props) {
        ...
        _this.validationSchema = {
            ...
            firstName: yup__WEBPACK_IMPORTED_MODULE_4__["string"]().required('Поле является обязательным').trim(),
            lastName: yup__WEBPACK_IMPORTED_MODULE_4__["string"]().required('Поле является обязательным').trim(),
            password: yup__WEBPACK_IMPORTED_MODULE_4__["string"]().required('Поле является обязательным').trim(),
            confirmPassword: yup__WEBPACK_IMPORTED_MODULE_4__["string"]().required('Поле является обязательным').trim(),
        };
    ...
    RegistrationFormComponent.prototype.render = function () {
        ...
        if (!initialValues) {
            return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_shared_wrappers_FormPlaceholder__WEBPACK_IMPORTED_MODULE_12__["FormPlaceholder"], null);
        }
        return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_0__["Formik"], { enableReinitialize: true, onSubmit: this._onSubmit, validationSchema: this._createValidationSchemaObject(), validateOnBlur: true, initialValues: initialValues }, function (props) {
            ...
            return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__["Form"], { success: !!_this.props.form.formSuccess, loading: props.isSubmitting, error: !!((_a = _this.props.form.formError) === null || _a === void 0 ? void 0 : _a.message), onSubmit: props.handleSubmit },
                react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_i18next__WEBPACK_IMPORTED_MODULE_13__["Translation"], null, function (t) { return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null,
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "registrationForm" },
                        react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_shared_input_inputComponent__WEBPACK_IMPORTED_MODULE_10__["InputComponent"], { placeholder: t("Full name"), required: true, autoFocus: true, name: "userName" }),
                        react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_shared_input_inputComponent__WEBPACK_IMPORTED_MODULE_10__["InputComponent"], { placeholder: t("First name"), required: true, autoFocus: true, name: "firstName" }),
                        react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_shared_input_inputComponent__WEBPACK_IMPORTED_MODULE_10__["InputComponent"], { placeholder: t("Last name"), required: true, autoFocus: true, name: "lastName" }),
                        react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_shared_input_inputComponent__WEBPACK_IMPORTED_MODULE_10__["InputComponent"], { placeholder: "Email", required: true, autoFocus: true, name: "email" }),
                        react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_shared_input_inputComponent__WEBPACK_IMPORTED_MODULE_10__["InputComponent"], { placeholder: t("Password"), required: true, inputProps: { type: "password" }, name: "password" }),
                        react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_shared_input_inputComponent__WEBPACK_IMPORTED_MODULE_10__["InputComponent"], { placeholder: t("Repeat password"), required: true, inputProps: { type: "password" }, name: "confirmPassword" })),
                    react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "pushButtons" },
                        react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_shared_buttons_buttonComponent__WEBPACK_IMPORTED_MODULE_9__["ButtonComponent"], { onClick: function () { return _this._onSubmit({
                                ...
                                confirmPassword: _this.props.form.record.confirmPassword,
                                role: "user"
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_shared_wrappers_FormMessageWrapper__WEBPACK_IMPORTED_MODULE_11__["FormMessageWrapper"], { isSuccess: true }, _this.getCustomSuccessMessage()),
                    react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_shared_wrappers_FormMessageWrapper__WEBPACK_IMPORTED_MODULE_11__["FormMessageWrapper"], { isError: true }, _this.getCustomErrorMessage()))); })));
        }));
    };
    ;
...
//# sourceMappingURL=app.64ff973484b3dce5d871.hot-update.js.map