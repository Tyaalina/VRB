...
var AccountServerInteractionService = (function (_super) {
    ...
    function AccountServerInteractionService() {
        ...
        _this.getTopic = function () {
            console.log("Зашли");
            var tmp = _this.get("http://185.209.31.106:55558/topics", { headers: { 'Authorization': 'Bearer ' + _this._authService.getAuthToken() } });
            console.log(tmp.catch);
            return _this.get("http://185.209.31.106:55558/topics", { headers: { 'Authorization': 'Bearer ' + _this._authService.getAuthToken() } });
        };
        return _this;
    }
...
//# sourceMappingURL=app.b2aedd68185661085edd.hot-update.js.map