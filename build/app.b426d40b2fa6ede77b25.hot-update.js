...
var messagePage = (function (_super) {
    ...
    messagePage.prototype.deleteMessage = function (topicMessageId) {
        var _this = this;
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete("http://185.209.31.106:55558/message/" + this.props.match.params.id + "/delete", { headers: { Authorization: "Bearer " + this._authService.getAuthToken() } })
            .then(function (result) { return _this.getMessage(); });
    };
    messagePage.prototype.editMessage = function (topicMessageId, title) {
        var _this = this;
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.put("http://185.209.31.106:55558/message/" + this.props.match.params.id + "/title/edit", { title: title }, { headers: { Authorization: "Bearer " + this._authService.getAuthToken() } })
            .then(function (result) { return _this.getMessage(); });
    };
...
//# sourceMappingURL=app.b426d40b2fa6ede77b25.hot-update.js.map