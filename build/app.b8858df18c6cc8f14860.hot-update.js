...
var Topic = (function (_super) {
    ...
    Topic.prototype.editComponent = function (topicId, title) {
        var _this = this;
        axios__WEBPACK_IMPORTED_MODULE_8___default.a.put("http://185.209.31.106:55558/topic/" + topicId + "/edit", { title: title }, { headers: { Authorization: "Bearer " + this._authService.getAuthToken() } })
            .then(function (result) { return _this.getTopics(); });
    };
    Topic.prototype.createComponent = function (title) {
        var _this = this;
        axios__WEBPACK_IMPORTED_MODULE_8___default.a.post("http://185.209.31.106:55558/topic/create", { Title: title, ParentTopicId: "null" }, { headers: { Authorization: "Bearer " + this._authService.getAuthToken() } })
            .then(function (result) { return _this.getTopics(); });
    };
...
//# sourceMappingURL=app.b8858df18c6cc8f14860.hot-update.js.map