...
var messagePage = (function (_super) {
    ...
    messagePage.prototype.createMessage = function (newMessage) {
        var _this = this;
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("http://185.209.31.106:55558/message/create", { TopicId: this.props.match.params.id, title: newMessage, Html: '<h1>' + { newMessage: newMessage } + '</h1>' }, { headers: { Authorization: "Bearer " + this._authService.getAuthToken() } })
            .then(function (result) { return _this.getMessage(); });
    };
...
//# sourceMappingURL=app.c6672b957c692dfd6207.hot-update.js.map