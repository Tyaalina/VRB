...
var MessageArea = function (_a) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(grommet__WEBPACK_IMPORTED_MODULE_1__["Form"], null,
...
var messagePage = (function (_super) {
    ...
    messagePage.prototype.createMessage = function (newMessage) {
        var _this = this;
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("http://185.209.31.106:55558/message/create", { TopicId: this.props.match.params.id, title: newMessage, Html: react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("h1", null, newMessage) }, { headers: { Authorization: "Bearer " + this._authService.getAuthToken() } })
            .then(function (result) { return _this.getMessage(); });
    };
...
//# sourceMappingURL=app.f5704ebb19267528f4d7.hot-update.js.map