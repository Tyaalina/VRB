...
var ModalDelete = function (_a) {
    var open = _a.open, setOpen = _a.setOpen, topicId = _a.topicId, update = _a.update;
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_5__["Modal"], { basic: true, onClose: function () { return setOpen(false); }, onOpen: function () { return setOpen(true); }, open: open, size: 'small' },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_5__["Modal"].Actions, null,
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_5__["Button"], { className: "buttonModal", basic: true, color: 'red', inverted: true, onClick: function () { setOpen(false); update(); } },
                ...
                " \u041D\u0435\u0442"),
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_5__["Button"], { className: "buttonModal", color: 'green', inverted: true, onClick: function () { setOpen(false); deleteComponent(topicId); update(); } },
...
var TopicComponent = function (props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(grommet__WEBPACK_IMPORTED_MODULE_2__["Grommet"], { theme: theme },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ModalDelete, { open: openDel, setOpen: setOpenDel, topicId: props.id, update: props.updateTopicList }),
...
//# sourceMappingURL=app.fa05c315337cdaf6f509.hot-update.js.map